...
/**
 * A DTO for the {@link wf.transotas.domain.Indice} entity.
 */
...
public class IndiceDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IndiceDTO)) {
            return false;
        }

        IndiceDTO indiceDTO = (IndiceDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, indiceDTO.id);
    }
