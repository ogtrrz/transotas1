...
/**
 * Criteria class for the {@link wf.transotas.domain.Categorys} entity. This class is used
 * in {@link wf.transotas.web.rest.CategorysResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /categorys?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CategorysCriteria implements Serializable, Criteria {
    ...
    public CategorysCriteria(CategorysCriteria other) {
    ...
    @Override
    public CategorysCriteria copy() {
        return new CategorysCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CategorysCriteria that = (CategorysCriteria) o;
        return (
