...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDICE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INDICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INDICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INDICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INDICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INDICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INDICE actions', async () => {
      const expectedActions = [
        {
