...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFORMACION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INFORMACIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INFORMACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INFORMACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INFORMACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INFORMACION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INFORMACION actions', async () => {
      const expectedActions = [
        {
