...
export const ComentariosDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="transotas1App.comentarios.delete.question">
        <Translate contentKey="transotas1App.comentarios.delete.question" interpolate={{ id: comentariosEntity.id }}>
