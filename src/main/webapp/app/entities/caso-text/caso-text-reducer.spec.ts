...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASOTEXT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CASOTEXTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CASOTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CASOTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CASOTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CASOTEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CASOTEXT actions', async () => {
      const expectedActions = [
        {
