...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORTES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REPORTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REPORTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPORTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPORTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPORTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPORTES actions', async () => {
      const expectedActions = [
        {
