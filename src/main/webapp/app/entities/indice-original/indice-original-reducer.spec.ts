...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDICEORIGINAL_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INDICEORIGINALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INDICEORIGINAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INDICEORIGINAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INDICEORIGINAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INDICEORIGINAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INDICEORIGINAL actions', async () => {
      const expectedActions = [
        {
