...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORYS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CATEGORYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CATEGORYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORYS actions', async () => {
      const expectedActions = [
        {
